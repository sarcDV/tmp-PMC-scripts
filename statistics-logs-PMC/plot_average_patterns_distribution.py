...
# tmp_axis_x = calculate_diff(time_x[0::30])
tmp_offtrx = calculate_diff(offtrx_+(offtrxstd_))#[0::30])
tmp_ontrx = calculate_diff(ontrx_+(ontrxstd_))#[0::30])

tmp_offtry = calculate_diff(offtry_+(offtrystd_))#[0::30])
tmp_ontry = calculate_diff(ontry_+(ontrystd_))#[0::30])

tmp_offtrz = calculate_diff(offtrz_+(offtrzstd_))#[0::30])
tmp_ontrz = calculate_diff(ontrz_+(ontrzstd_))#[0::30])

tmp_offrx = calculate_diff(offrx_+(offrxstd_))#[0::30])
tmp_onrx = calculate_diff(onrx_+(onrxstd_))#[0::30])

tmp_offry = calculate_diff(offry_+(offrystd_))#[0::30])
tmp_onry = calculate_diff(onry_+(onrystd_))#[0::30])

tmp_offrz = calculate_diff(offrz_+(offrzstd_))#[0::30])
tmp_onrz = calculate_diff(onrz_+(onrzstd_))#[0::30])
...
# 
plt.subplot(231)
# plt.hist2d(tmp_offtrx,tmp_ontrx,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
...
ymin, ymax = plt.ylim()
plt.text(-0.018, ymax-(0.10*ymax), 'PMC OFF',  color=coff_, fontweight='bold', fontsize=11)
plt.text(-0.018, ymax-(0.20*ymax), 'Mean = '+str(truncate(muoff,4)),  color=coff_, fontweight='bold', fontsize=11)
plt.text(-0.018, ymax-(0.30*ymax), 'Std = '+str(truncate(stdoff,4)),  color=coff_, fontweight='bold', fontsize=11)

plt.text(0.008, ymax-(0.10*ymax), 'PMC ON',  color=con_, fontweight='bold', fontsize=11)
plt.text(0.008, ymax-(0.20*ymax), 'Mean = '+str(truncate(muon,4)),  color=con_, fontweight='bold', fontsize=11)
plt.text(0.008, ymax-(0.30*ymax), 'Std = '+str(truncate(stdon,4)),  color=con_, fontweight='bold', fontsize=11)
plt.grid()


# 
plt.subplot(232)
# plt.hist2d(tmp_offtry,tmp_ontry,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
...
# 
plt.subplot(233)
# plt.hist2d(tmp_offtrz,tmp_ontrz,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
...
# 
plt.subplot(234)
# plt.hist2d(tmp_offrx,tmp_onrx,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
...
# 
plt.subplot(235)
# plt.hist2d(tmp_offry,tmp_onry,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
...
# 
plt.subplot(236)
# plt.hist2d(tmp_offrz,tmp_onrz,bins=nbins)
# plt.xlim([-0.02,0.02])
# plt.ylim([-0.02,0.02])
